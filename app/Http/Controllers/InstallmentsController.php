...
class InstallmentsController extends Controller
{
    ...
    public function payByAlipay(Installment $installment)
    {
        ...
        return app('alipay')->web([
            ...
            'subject'      => '支付 Sat Shop 的分期订单：'.$installment->no,
            // 这里的 notify_url 和 return_url 可以覆盖掉在 AppServiceProvider 设置的回调地址
            'notify_url'   => ngrok_url('installments.alipay.notify'), // 后端
            'return_url'   => route('installments.alipay.return'), // 前端
        ]);
    }

    // 支付宝前端回调 alipayReturn
    ...
    */
    ...
    // 分期付款对应微信退款回调方法 wechatRefundNotify
    public function wechatRefundNotify(Request $request)
    {
        ...
        // 根据单号拆解出对应的商品退款单号及对应的还款计划序号 out_refund_no
